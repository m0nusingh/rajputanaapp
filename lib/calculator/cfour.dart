...
class CfourPage extends StatefulWidget {
  State<StatefulWidget> createState() {
    return CfourPageState();
  }
}

class CfourPageState extends State<CfourPage> {
  String result = '0.0';
  int lock = 0;
  ...
  _calculate() {
    if (this.dm.text == '' &&
      ...
      double res = (3.1428*dm*dm*0.001*0.001*l*7700);
