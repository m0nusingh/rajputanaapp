...
class SevenpPage extends StatefulWidget {
  State<StatefulWidget> createState() {
    return SevenpPageState();
  }
}

class SevenpPageState extends State<SevenpPage> {
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text('Stainless Steel WR', style: head),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text('(Wire Rods)', style: heado),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                              ...
                              Padding(
                                ...
                                child: new Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text('5.5 mm to 28 mm', style: normal),
                                  ],
                                ),
                              ),
                              Padding(
                                ...
                                child: new Row(
                                  ...
                                  children: <Widget>[
                                    Text(
                                     ...
                                     Flexible(child: Container(child: Text('Bar & Wire re-drawing Fastners & Cold Heading', style: normal))),
